...
\*============================================================================*/
function websocket_open($host='', $port=80, $headers=array(), &$error_string='', $timeout=10, $ssl=false, $persistant = false, $path = '/', $context = null){
...
function websocket_write($sp, $data, $final=true)
{
  ...
  $dt = hybi10Encode($data, 'text', true);
  return fwrite($sp,$dt);
}
function websocket_write2($sp, $data, $final=true)
{
  // Assamble header: FINal 0x80 | Opcode 0x02
...
/*============================================================================*\
 ...
 \*============================================================================*/
function websocket_read($sp, &$error_code=NULL, &$error_string=NULL){
  $data="";
  $error_code = "000";
  do
  {
